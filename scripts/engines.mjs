...
export const ENGINES = [
  {
    ...
    match: /B&S 500E|Briggs.*500E|500E Series|B&S 575EX|Briggs.*575EX/i,
...

  {
    ...
    match: /B&S 6\d{2}EX|Briggs.*6\d{2}EX|675EX|750EX|625EX/i,
...

  {
    ...
    name: 'Briggs & Stratton Intek V-Twin',
    country: 'USA',
    family: 'Ride-on / lawn-tractor V-twin OHV',
    match: /Intek.*V-twin|Intek 7180|Intek 8240|Intek.*V twin/i,
    ...
    profile: "The Briggs Intek 7180 V-twin is the engine inside the Murray MX175-107, the Cub Cadet XT2, and many John Deere E-series tractors. Briggs sells it to anyone who wants it, so the same block sits under wildly different deck colours and price tags. Smooth, durable, and well-supported — the obvious upgrade from a single-cylinder Intek for any half-acre+ lawn.",
  ...
  {
    slug: 'honda-gcv',
    name: 'Honda GCV Series',
    country: 'Japan',
    family: 'Walk-behind premium petrol — OHC',
    match: /Honda GCV|GCV1[4-7]0|GCVx 170/i,
...

  {
    ...
    country: 'Italy',
    family: 'Walk-behind petrol — OHV single',
    match: /Stiga ST\d|ST120|ST140|ST160|RV150|RV170/i,
